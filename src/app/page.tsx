...
function HomePage() {
  return (
    <div className="w-full h-full bg-[url('/images/hero-2.png')] bg-no-repeat bg-center bg-fixed bg-cover">
      <div className="bg-black w-full h-full bg-opacity-50">
        ...
        <header className="max-w-7xl mx-auto flex items-center justify-between px-6 pb-10 pt-6">
          ...
          <Link href={"/client/auth"}>
            <button className="text-white bg-red-600 rounded w-ful h-9 p-4 flex justify-center items-center">
              Sign In
            </button>
          </Link>
        </header>
        ...
        <div className="flex flex-col items-center justify-center text-center py-48 text-white max-w-6xl mx-auto">
          ...
          <form
            className="flex flex-col gap-2 items-center sm:items-start sm:flex-row "
          ...
          >
            ...
            <button
              className=" bg-red-600 rounded h-14 w-52
            "
            >
              Get Started
